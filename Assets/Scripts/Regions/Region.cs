...
public class Region : MonoBehaviour
{
    ...
    public void Refresh()
    {
        ...
        if (data.health <= 20){
            ConsoleManager.Instance.AddEntry($"Breaking News: {data.regionName} is at critical health.");
            data.isCritical = true;
        }
    
        data.economy += (data.economyChangeRate / 10f) * Random.Range(100f - (100-data.stability), 100f + (100-data.stability)) /100f;
        data.tax += (data.economyChangeRate / 10f) * Random.Range(100f - (100-data.stability), 100f + (100-data.stability)) /100f;
        data.education += (data.educationChangeRate / 10f) * Random.Range(100f - (100-data.stability), 100f + (100-data.stability)) /100f;
        data.stability += (data.stabilityChangeRate / 10f) * Random.Range(100f - (100-data.stability), 100f + (100-data.stability)) /100f;
        data.compliance += (data.complianceChangeRate / 10f) * Random.Range(100f - (100-data.stability), 100f + (100-data.stability)) /100f;
        data.happiness += (data.happinessChangeRate / 10f) * Random.Range(100f - (100-data.stability), 100f + (100-data.stability)) /100f;
        data.health += (data.healthChangeRate / 10f) * Random.Range(100f - (100-data.stability), 100f + (100-data.stability)) /100f;
